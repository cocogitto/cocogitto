...
changelog_test!(
    ...
    ReleaseFixture::default(),
    Template::from_arg("monorepo_default", None, false)?.with_context(default_pacakage_context()),
    "## 1.0.0 - 2015-09-05
        ### Packages
        - one locked to 0.1.0
        - two locked to 0.2.0
...
changelog_test!(
    ...
    Template::from_arg("github", default_remote_context(), false)?,
    "
        "
);
...
changelog_test!(
    ...
    ReleaseFixture::default(),
    Template::from_arg("default", None, true)?,
    "## 1.0.0 - 2015-09-05
            ### Package updates
            - one bumped to 0.1.0
            - two bumped to 0.2.0
...
changelog_test!(
    ...
    ReleaseFixture::default(),
    Template::from_arg("fullhash", None, true)?,
    "### Package updates
            - one bumped to 0.1.0
            - two bumped to 0.2.0
            ### All changes
...
changelog_test!(
    ...
    ReleaseFixture::default(),
    Template::from_arg("remote", default_remote_context(), true)?,
    "## [1.0.0](https://github.com/cocogitto/cocogitto/compare/0.1.0..1.0.0) - 2015-09-05
            ### Package updates
            - [0.1.0](crates/one) bumped to [0.1.0](https://github.com/cocogitto/cocogitto/compare/0.2.0..0.1.0)
            - [0.2.0](crates/two) bumped to [0.2.0](https://github.com/cocogitto/cocogitto/compare/0.3.0..0.2.0)
