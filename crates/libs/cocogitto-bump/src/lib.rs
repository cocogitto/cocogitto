...
use crate::increment::IncrementCommand;
...
mod test {
    ...
    use crate::auto_global_bump;
    use crate::bump;
    use crate::error::BumpError;
    use crate::get_monorepo_global_version_from_commit_history;
    use crate::increment::IncrementCommand;
    use crate::version_increment_from_commit_history;
