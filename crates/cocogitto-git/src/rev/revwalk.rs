...
use crate::rev::filters::PackagePathFilter;
use crate::rev::CommitIter;
...
mod test {
    ...
    use crate::test::{commit, get_workspace_root, git_tag};
    use anyhow::Result;
    ...
    fn from_tag_to_tag_ok() -> Result<()> {
        ...
        let _v1_0_0 = OidOf::Tag(Tag::from_str(
            "1.0.0",
            Some(v1_0_0),
            None,
            SETTINGS.tag_prefix(),
        ...
        let v3_0_0 = OidOf::Tag(Tag::from_str(
            "3.0.0",
            Some(v3_0_0),
            None,
            SETTINGS.tag_prefix(),
    ...
    fn from_previous_to_tag() -> Result<()> {
        ...
        let _v2_1_1 = OidOf::Tag(Tag::from_str(
            "2.1.1",
            Some(v2_1_1),
            None,
            SETTINGS.tag_prefix(),
